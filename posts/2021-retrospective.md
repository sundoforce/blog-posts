...
# 1. 회사에서의 성장
## 1.1 주언어 변경
고객사의 요청에 따라 `Node.js` 를 사용 하다가 회사 주언어 `Python`을  잠시 사용하다가 대세인 Java를 익히려고 노력한 한 해 였습니다.
...
App Store, Play Store에 올리면서 reject 이 여러차례 되면서 시행착오들을 경험하면서 쉬운 것이 아니구나를 느꼈습니다. 
...
# 6. 백엔드 개발에서 클라우드로 전환
현재 재직중인 회사에 `2018.01.02 ~ 2021.12.31` 만 4년을 채우고  
public cloud 플랫폼 담당으로 2022년 1월 3일 부터 클라우드 회사로 이직하게 되었습니다.  

프로그램들이 잘 돌아갈 수 있게 시스템설계와 운영을 배워가며 잘 하고 싶습니다.

2021년에 SI를 벗어나고자 여러가지 일을 했습니다.
> 아무것도 하지 않으면 아무 일도 일어나지 않는다

감사하게도 정말 많은 회사에서 연락이 왔었고, 죄송한 마음으로 거절하였습니다.  
거절 한 것 중 아쉬운 도전은 MS 인턴쉽이였고 실제 AWS Korea는 2번의 면접까지 진행되었습니다.    
...
> 며칠만에 코딩테스트를 대비 하는것은 불가능 했습니다. 

카카오 코딩테스트는  해커랭크에서 `python`으로 1번     
쿠팡은 특별한 경험과 지원자(저)에 대한 배려를 받았는데 프로그래머스에서 `Python` 으로 1번  
몇 달 후 언어를 `Java` 변경해서 도전 하여, 총 2번 보았습니다.   
대전에 있는 세트렉아이라는 회사의 코딩테스트는 특별한 경험이였습니다.  
